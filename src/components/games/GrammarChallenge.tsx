...
const grammarQuestions: GrammarQuestion[] = [
  ...
  // Additional Fill-in-the-Blank
  {
    id: 'fb-6',
    type: 'fill-blank',
    sentence: ['Neither my brother', 'my sister can drive.'],
    blankPosition: 0,
    options: ['or', 'nor', 'and', 'but'],
    correctAnswer: 'nor',
    explanation: 'Use "neither...nor" together to express two negatives.',
    level: 'B1',
  },
  {
    id: 'fb-7',
    type: 'fill-blank',
    sentence: ['The cake', 'by my grandmother last night.'],
    blankPosition: 0,
  ...
  },
  {
    id: 'fb-8',
    type: 'fill-blank',
    sentence: ['I would rather', 'at home tonight.'],
    blankPosition: 0,
    options: ['stay', 'to stay', 'staying', 'stayed'],
    correctAnswer: 'stay',
    explanation: 'After "would rather", use the bare infinitive (no "to").',
    level: 'B2',
  },
  {
    id: 'fb-9',
    type: 'fill-blank',
    sentence: ['She\'s the person', 'car was stolen yesterday.'],
    blankPosition: 0,
  ...
  },
  {
    id: 'fb-10',
    type: 'fill-blank',
    sentence: ['Hardly', 'I sat down when the phone rang.'],
    blankPosition: 0,
    options: ['had', 'did', 'was', 'have'],
    correctAnswer: 'had',
    explanation: 'Inversion after "hardly" uses past perfect: "Hardly had I..."',
    level: 'C1',
  },
  {
    id: 'fb-11',
    type: 'fill-blank',
    sentence: ['She denied', 'the money.'],
    blankPosition: 0,
  ...
  },
  {
    id: 'fb-12',
    type: 'fill-blank',
    sentence: ['If I had known, I', 'you earlier.'],
    blankPosition: 0,
  ...
  // Additional Verb Tenses
  {
    id: 'tense-7',
    type: 'tense',
    sentence: ['I', 'for this company since 2019.'],
    blankPosition: 0,
    options: ['work', 'worked', 'have worked', 'am working'],
    correctAnswer: 'have worked',
    explanation: 'Present perfect with "since" shows an action from the past continuing to now.',
    level: 'B1',
  },
  {
    id: 'tense-8',
    type: 'tense',
    sentence: ['While she', 'dinner, the doorbell rang.'],
    blankPosition: 0,
    options: ['cooked', 'was cooking', 'cooks', 'had cooked'],
    correctAnswer: 'was cooking',
    explanation: 'Past continuous shows an ongoing action interrupted by another past event.',
    level: 'B1',
  },
  {
    id: 'tense-9',
    type: 'tense',
    sentence: ['By the time you arrive, I', 'already.'],
    blankPosition: 0,
    options: ['leave', 'will leave', 'will have left', 'am leaving'],
    correctAnswer: 'will have left',
    explanation: 'Future perfect shows an action completed before a future time.',
    level: 'B2',
  },
  {
    id: 'tense-10',
    type: 'tense',
    sentence: ['They', 'for over an hour before the bus came.'],
    blankPosition: 0,
    options: ['waited', 'were waiting', 'had been waiting', 'have been waiting'],
    correctAnswer: 'had been waiting',
    explanation: 'Past perfect continuous shows a past action in progress before another past event.',
    level: 'C1',
  },
  {
    id: 'tense-11',
    ...
    blankPosition: 0,
    options: ['boils', 'is boiling', 'boil', 'has boiled'],
    correctAnswer: 'boils',
  ...
  },
  {
    id: 'tense-12',
    type: 'tense',
    sentence: ['Look! It', 'snowing.'],
    blankPosition: 0,
    options: ['starts', 'is starting', 'started', 'has started'],
    correctAnswer: 'is starting',
    explanation: 'Present continuous for actions happening right now, often signaled by "look" or "listen".',
    level: 'A2',
  },
  ...
  // Additional Articles
  {
    id: 'art-7',
    type: 'article',
    sentence: ['I love', 'music, especially jazz.'],
    blankPosition: 0,
    options: ['a', 'an', 'the', '-'],
    correctAnswer: '-',
    explanation: 'No article with uncountable nouns used in a general sense (music, love, water).',
    level: 'A2',
  },
  {
    id: 'art-8',
    type: 'article',
    sentence: ['He is', 'best student in the class.'],
    blankPosition: 0,
    options: ['a', 'an', 'the', '-'],
    correctAnswer: 'the',
    explanation: 'Use "the" with superlatives (the best, the tallest, the fastest).',
    level: 'A2',
  },
  {
    id: 'art-9',
    type: 'article',
    sentence: ['She went to', 'hospital last week.'],
    blankPosition: 0,
    options: ['a', 'an', 'the', '-'],
    correctAnswer: '-',
    explanation: 'In British English, no article with institutions used for their purpose (hospital, school, prison).',
    level: 'B1',
  },
  {
    id: 'art-10',
    type: 'article',
    sentence: ['I bought a book.', 'book was very interesting.'],
    blankPosition: 0,
    options: ['A', 'An', 'The', '-'],
    correctAnswer: 'The',
    explanation: 'Use "the" when the noun is already known from context (second mention).',
    level: 'A1',
  },
  {
    id: 'art-11',
    type: 'article',
    sentence: ['She lives in', 'United States.'],
    blankPosition: 0,
    options: ['a', 'an', 'the', '-'],
    correctAnswer: 'the',
    explanation: 'Use "the" with country names containing "states", "kingdom", "republic" (the US, the UK, the Czech Republic).',
    level: 'A2',
  },
  {
    id: 'art-12',
    type: 'article',
    sentence: ['We had', 'amazing time at the party.'],
    blankPosition: 0,
    options: ['a', 'an', 'the', '-'],
    correctAnswer: 'an',
    explanation: 'Use "an" before vowel sounds (amazing starts with "a" sound).',
    level: 'A1',
  },
  ...
  // Additional Prepositions
  {
    id: 'prep-9',
    type: 'preposition',
    sentence: ['She is good', 'solving puzzles.'],
    blankPosition: 0,
    options: ['at', 'in', 'on', 'for'],
    correctAnswer: 'at',
    explanation: 'Use "good at" + noun/gerund to describe skills.',
    level: 'A2',
  },
  {
    id: 'prep-10',
    type: 'preposition',
    sentence: ['I apologized', 'being late.'],
    blankPosition: 0,
    options: ['about', 'for', 'of', 'on'],
    correctAnswer: 'for',
    explanation: 'Use "apologize for" + noun/gerund when saying sorry.',
    level: 'B1',
  },
  {
    id: 'prep-11',
    type: 'preposition',
    sentence: ['He is afraid', 'spiders.'],
    blankPosition: 0,
    options: ['of', 'from', 'with', 'about'],
    correctAnswer: 'of',
    explanation: 'Use "afraid of" to express fear of something.',
    level: 'A2',
  },
  {
    id: 'prep-12',
    type: 'preposition',
    sentence: ['The plane arrives', '6:30 PM.'],
    blankPosition: 0,
    options: ['at', 'in', 'on', 'by'],
    correctAnswer: 'at',
    explanation: 'Use "at" for specific times of day (at 6:30, at noon, at midnight).',
    level: 'A1',
  },
  {
    id: 'prep-13',
    type: 'preposition',
    sentence: ['She is responsible', 'hiring new staff.'],
    blankPosition: 0,
    options: ['for', 'of', 'about', 'with'],
    correctAnswer: 'for',
    explanation: 'Use "responsible for" to indicate duty or accountability.',
    level: 'B1',
  },
  {
    id: 'prep-14',
    type: 'preposition',
    sentence: ['Are you interested', 'joining the club?'],
    blankPosition: 0,
    options: ['in', 'on', 'about', 'for'],
    correctAnswer: 'in',
    explanation: 'Use "interested in" + noun/gerund to show interest.',
    level: 'A2',
  },
];
