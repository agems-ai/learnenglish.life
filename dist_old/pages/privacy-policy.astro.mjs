...
const $$PrivacyPolicy = createComponent(($$result, $$props, $$slots) => {
  ...
  return Astro2.redirect("/privacy", 301);
}, "/var/www/learnenglish.life/src/pages/privacy-policy.astro", void 0);

const $$file = "/var/www/learnenglish.life/src/pages/privacy-policy.astro";
